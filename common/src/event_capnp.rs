...
pub mod event_interface {
  ...
  pub type TriggerParams<> = ::capnp::capability::Params<crate::event_capnp::event_interface::trigger_params::Owned>;
  pub type TriggerResults<> = ::capnp::capability::Results<crate::event_capnp::event_interface::trigger_results::Owned>;
  ...
  impl  Client {
    pub fn trigger_request(&self) -> ::capnp::capability::Request<crate::event_capnp::event_interface::trigger_params::Owned,crate::event_capnp::event_interface::trigger_results::Owned> {
      self.client.new_call(_private::TYPE_ID, 0, ::core::option::Option::None)
    }
  }
  pub trait Server<>   {
    fn trigger(&mut self, _: TriggerParams<>, _: TriggerResults<>) -> ::capnp::capability::Promise<(), ::capnp::Error> { ::capnp::capability::Promise::err(::capnp::Error::unimplemented("method event_interface::Server::trigger not implemented".to_string())) }
  }
  ...
  impl <_T :Server> ServerDispatch<_T> {
    pub fn dispatch_call_internal(server: &mut _T, method_id: u16, params: ::capnp::capability::Params<::capnp::any_pointer::Owned>, results: ::capnp::capability::Results<::capnp::any_pointer::Owned>) -> ::capnp::capability::Promise<(), ::capnp::Error> {
      match method_id {
        0 => server.trigger(::capnp::private::capability::internal_get_typed_params(params), ::capnp::private::capability::internal_get_typed_results(results)),
        _ => { ::capnp::capability::Promise::err(::capnp::Error::unimplemented("Method not implemented.".to_string())) }
      }
    }
  }
  pub mod _private {
    pub const TYPE_ID: u64 = 0xdc89_f0a5_7d82_7600;
  }
  ...
  pub mod event {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 70] = [
        ...
        ::capnp::word(116, 73, 110, 116, 101, 114, 102, 97),
        ::capnp::word(99, 101, 46, 69, 118, 101, 110, 116),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub mod message {
      ...
      mod _private {
        pub static ENCODED_NODE: [::capnp::Word; 50] = [
          ...
          ::capnp::word(116, 73, 110, 116, 101, 114, 102, 97),
          ::capnp::word(99, 101, 46, 69, 118, 101, 110, 116),
          ::capnp::word(46, 77, 101, 115, 115, 97, 103, 101),
          ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ...
        pub const TYPE_ID: u64 = 0x85a2_2872_8f39_6ce9;
      }
    }
  }

  pub mod trigger_params {
    #[derive(Copy, Clone)]
    pub struct Owned(());
    impl ::capnp::introspect::Introspect for Owned { fn introspect() -> ::capnp::introspect::Type { ::capnp::introspect::TypeVariant::Struct(::capnp::introspect::RawBrandedStructSchema { generic: &_private::RAW_SCHEMA, field_types: _private::get_field_types, annotation_types: _private::get_annotation_types }).into() } }
    impl ::capnp::traits::Owned for Owned { type Reader<'a> = Reader<'a>; type Builder<'a> = Builder<'a>; }
    ...
    impl <'a,> Reader<'a,>  {
      ...
      #[inline]
      pub fn get_event(self) -> ::capnp::Result<crate::event_capnp::event_interface::event::Reader<'a>> {
        ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(0), ::core::option::Option::None)
      }
      #[inline]
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn get_event(self) -> ::capnp::Result<crate::event_capnp::event_interface::event::Builder<'a>> {
        ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
      }
      #[inline]
      pub fn set_event(&mut self, value: crate::event_capnp::event_interface::event::Reader<'_>) -> ::capnp::Result<()> {
        ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
      }
      #[inline]
      pub fn init_event(self, ) -> crate::event_capnp::event_interface::event::Builder<'a> {
    ...
    impl Pipeline  {
      pub fn get_event(&self) -> crate::event_capnp::event_interface::event::Pipeline {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 34] = [
        ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
        ::capnp::word(181, 145, 13, 85, 16, 130, 94, 211),
        ...
        ::capnp::word(112, 110, 112, 58, 69, 118, 101, 110),
        ::capnp::word(116, 73, 110, 116, 101, 114, 102, 97),
        ::capnp::word(99, 101, 46, 116, 114, 105, 103, 103),
      ...
      pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
        match index {
          0 => <crate::event_capnp::event_interface::event::Owned as ::capnp::introspect::Introspect>::introspect(),
          _ => panic!("invalid field index {}", index),
        }
      }
      pub fn get_annotation_types(child_index: Option<u16>, index: u32) -> ::capnp::introspect::Type {
      ...
      pub const TYPE_ID: u64 = 0xd35e_8210_550d_91b5;
    }
  }
  ...
  pub mod trigger_results {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 18] = [
        ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
        ::capnp::word(78, 152, 83, 116, 30, 50, 214, 154),
        ::capnp::word(27, 0, 0, 0, 1, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      pub const TYPE_ID: u64 = 0x9ad6_321e_7453_984e;
    }
  }
}
